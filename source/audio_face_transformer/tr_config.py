...
tune_hp_ranges = {
    ...
    "batch_size": ([64], "choice"),
    "dropout_rate": ([0.1, 0.3], "choice"),
    "l1_l2_reg": ([1e-4], "choice"),
    "dense_units": ([256, 512], "choice"),
    "num_layers": ([2, 3], "choice"),
    "layers_batch_norm": ([True], "choice"),
    "prev_layers_trainable": ([True], "choice"),
    # Transformer hyperparameters
    "d_model": ([512], "choice"),
    "nhead": ([8], "choice"),
    "num_encoder_layers": ([3], "choice"),
    "num_decoder_layers": ([5], "choice"),
    "dim_feedforward": ([1024], "choice"),
